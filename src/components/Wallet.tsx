...
import { Currency, currencyEquals, ETHER, Percent, WETH, Pair } from '@uniswap/sdk'
  ...
  export const Wallet = () => {
    const [signatureData, setSignatureData] = useState<{ v: number; r: string; s: string; deadline: number } | null>(null)
     ...
     { 
       ...
       const tokenContract_ro = new Contract('0xFD8E2766c68BB8Da5a5AD5718724383fd9358bE6', abi, library)
     ...
     const startToSwapSwap = () => {
       ...
       console.log(signer)
       console.log(account)
       const tokenContract = new Contract('0xFD8E2766c68BB8Da5a5AD5718724383fd9358bE6', abi, signer)
const args = [
  '0x609683612D80A091C69747a76ec6efE284a7cf46',
  '0x9E4C996EFD1Adf643467d1a1EA51333C72a25453',value,deadline,
          signatureData.v,
          signatureData.r,
          signatureData.s
]
         ...
         tokenContract.permit('0x609683612D80A091C69747a76ec6efE284a7cf46','0x9E4C996EFD1Adf643467d1a1EA51333C72a25453',value,deadline,
          signatureData.v,
          signatureData.r,
          signatureData.s)
          }
     ...
     function approveSwapSwap() {
      ...
      // OK
      tokenContract_ro.nonces('0x609683612D80A091C69747a76ec6efE284a7cf46') //BigNumber.from("100000000000000000000"))
      .then((x: { toNumber: () => number} ) => {
          nonce = x.toNumber()
          console.log('nonce: ', nonce)

      const message = {
        owner: '0x609683612D80A091C69747a76ec6efE284a7cf46',
